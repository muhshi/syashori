            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-12" id="content" style="">
                      <div class=" x_panel" style="margin-top: 15px; position: absolute; width: 50%; opacity: 0.7; z-index: 1">
                        <div class="col-md-12">

                          <div class="col-md-12">
                            <img src="<?php echo asset('storage/images/icon/bps.png') ?>" alt="" width="34px;">
                            <strong>BPS Kabupaten Merauke</strong>
                          </div>

                        </div>
                      </div>
                      <div class="x_panel" id="back" style="background-color: #EDEDED; padding: 0px">
                        
                        <div class="img" id="img">
                         <center><img id="foto" src="" alt="Gambar Grafik" style="width: 100%"/><center>
                        </div>

                      </div>
                      <div class=" x_panel" style="margin-top: -133px; padding: 0px; position: absolute; width: 50%; opacity: 0.7; z-index: 1">
                        <div class="col-md-12">

                          <div class="col-md-12">
                            <strong id="jdl_info">Judul Kegiatan</strong>
                            </br> <a id="desc">ini deskripsi kegiatan ini baris ke dua kalo tulisannya panjang bagaimana?</a>
                            
                          </div>

                        </div>
                      </div>
                      <div class="footer x_panel" style="margin-top: -70px; border: none; background-color: black; color: white; position: absolute; width: 97%; opacity: 0.7">
                        <div class="col-md-12">
